...
public class AppTests extends TestBase {
    ...
    void titleTest() {
        step("Open url 'https://lenta.ru/'", () ->
            open("https://lenta.ru/"));

        step("Page title should have text 'Lenta.ru - Новости России и мира сегодня'", () -> {
            String expectedTitle = "Lenta.ru - Новости России и мира сегодня";
